ALTER TABLE `ajxxscore`.`exam_student_scores` 
...
INSERT INTO `ajxxscore`.`sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1207, '考试分析', 1061, 3, 'analysis', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2023-05-23 20:55:34', 'admin', '2023-05-23 20:56:02', '');
